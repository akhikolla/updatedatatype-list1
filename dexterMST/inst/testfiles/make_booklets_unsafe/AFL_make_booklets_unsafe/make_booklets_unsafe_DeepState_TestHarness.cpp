...
TEST(,){
  ...
  std::string person_id_t = "/home/akhila/fuzzer_packages/fuzzedpackages/dexterMST/inst/testfiles/make_booklets_unsafe/AFL_make_booklets_unsafe/afl_inputs/" + std::to_string(t) + "_person_id.qs";
  ...
  std::string booklet_id_t = "/home/akhila/fuzzer_packages/fuzzedpackages/dexterMST/inst/testfiles/make_booklets_unsafe/AFL_make_booklets_unsafe/afl_inputs/" + std::to_string(t) + "_booklet_id.qs";
  ...
  std::string module_nbr_t = "/home/akhila/fuzzer_packages/fuzzedpackages/dexterMST/inst/testfiles/make_booklets_unsafe/AFL_make_booklets_unsafe/afl_inputs/" + std::to_string(t) + "_module_nbr.qs";
  ...
  std::string item_id_t = "/home/akhila/fuzzer_packages/fuzzedpackages/dexterMST/inst/testfiles/make_booklets_unsafe/AFL_make_booklets_unsafe/afl_inputs/" + std::to_string(t) + "_item_id.qs";
  qs::c_qsave(item_id,item_id_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "item_id values: "<< item_id << std::endl;
  IntegerVector item_score  = RcppDeepState_IntegerVector();
  std::string item_score_t = "/home/akhila/fuzzer_packages/fuzzedpackages/dexterMST/inst/testfiles/make_booklets_unsafe/AFL_make_booklets_unsafe/afl_inputs/" + std::to_string(t) + "_item_score.qs";
  ...
  std::string booklet_score_t = "/home/akhila/fuzzer_packages/fuzzedpackages/dexterMST/inst/testfiles/make_booklets_unsafe/AFL_make_booklets_unsafe/afl_inputs/" + std::to_string(t) + "_booklet_score.qs";
  ...
  std::string include_rsp_t = "/home/akhila/fuzzer_packages/fuzzedpackages/dexterMST/inst/testfiles/make_booklets_unsafe/AFL_make_booklets_unsafe/afl_inputs/" + std::to_string(t) + "_include_rsp.qs";
  ...
  std::string bk_nmod_t = "/home/akhila/fuzzer_packages/fuzzedpackages/dexterMST/inst/testfiles/make_booklets_unsafe/AFL_make_booklets_unsafe/afl_inputs/" + std::to_string(t) + "_bk_nmod.qs";
